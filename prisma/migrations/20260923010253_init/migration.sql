...
-- AddForeignKey
ALTER TABLE "ResourceSubmission" ADD CONSTRAINT "ResourceSubmission_stageId_fkey" FOREIGN KEY ("stageId") REFERENCES "RoadmapStage"("id") ON DELETE CASCADE ON UPDATE CASCADE;
